...
import temData from './temData.js' //临时假数据
import kdata from './temData.js'
      ...
      get() {
        return {
          line1: function (id) {
              ...
              this.chart.setOption(initMOption(temData.mdata,'hs'));        
						// var that = this
					},
					line2:function(id){
						this.chart = echarts.init(document.getElementById(id));
              this.chart.setOption(initKOption(temData.kdata)); 
					}
        }
      }
    },
...
var get_m_data = function(m_data,type) {
	...
	// console.log(priceArr,avgPrice,vol,times);
